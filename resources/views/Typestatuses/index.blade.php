...
@section('content')
					...
					<tbody align="center">
						...
						<tr>
							...
							<td style="display: inline-flex;border: none;">
								...
								<a href="{{url('typestatuses/'.$typestatus->id.'/edit')}}" class="btn btn-warning">Editar</a>
								<form action="{{url('typestatuses/'.$typestatus->id)}}" method="post">
									@csrf
									@method('DELETE')
	...
	@include('Typestatuses.addTypestatus')
