...
@section('content')
						...
						@foreach($datos as $dato)
							<tr>
								...
								<td style="display: inline-flex;border: none;">
									...
									<a href="{{url('movie_rental/'.$dato->id.'/edit')}}" class="btn btn-warning">Editar</a>
									<form action="{{url('movie_rental/'.$dato->id)}}" method="post">
										@csrf
										@method('DELETE')
	...
	@include('MovieRental.addMRental')
